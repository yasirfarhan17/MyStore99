...
public class productAdapter extends RecyclerView.Adapter <productAdapter.MyViewHolder>{
    ...
    ArrayList<popData> list1=new ArrayList<>();
    ...
    public productAdapter(ArrayList<product> p,Context c)
    {
        product1=p;
        context=c;
    }
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
       ...
       // Picasso.get().load(product1.get(position).getImg()).fit().into(holder.img);
        ...
        ref= FirebaseDatabase.getInstance().getReference("Cart");
         ...
         //holder.ins_box.setText(String.valueOf(product.getCount()));

        /*holder.btnIns.setOnClickListener(new View.OnClickListener()
        {
            @Override
        ...
        holder.btnDsc.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        holder.addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(key!=null) {
                    cartItem obj = new cartItem(product1.get(position).getProducts_name(), product1.get(position).getPrice(),1,Integer.parseInt(product1.get(position).getPrice())*1,product1.get(position).getQuant());
                    ref.child(key).child(product1.get(position).getProducts_name()).setValue(obj);
                    //Intent intent=new Intent(view.getContext(),AddressPage.class);
        ...
        /*holder.slectwt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Toast.makeText(view.getContext(),""+position,Toast.LENGTH_SHORT).show();
                MyAlertdialog(view,position);
            }
        });*/
  ...
  /*  public void MyAlertdialog (final View view1,int position) {


        mydialog = new Dialog(view1.getContext());
        mydialog.setContentView(R.layout.popup);

        recyclerView=mydialog.findViewById(R.id.weight_recyclerView1);
        ...
        ref= FirebaseDatabase.getInstance().getReference("variety").child(product1.get(position).getProducts_name());
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1:dataSnapshot.getChildren()){
                    String val=dataSnapshot1.child("rate").getValue().toString();
                    String val1=dataSnapshot1.child("weight").getValue().toString();
                    popData p=new popData(val1,val);
                    list1.add(p);
                }
                adapter=new popAdapter(list1,product1);
