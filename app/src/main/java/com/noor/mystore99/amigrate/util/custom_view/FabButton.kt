package com.noor.mystore99.amigrate.util.custom_view
...
private val STATE_KEY = FabButton::class.java.name + ".STATE"
 ...
 */
open class FabButton @JvmOverloads constructor(
    context: Context,
    ...
    private val animationProperty =
        object : Property<FabButton, Float>(Float::class.java, "animation") {

            override fun set(counterFab: FabButton, value: Float) {
                animationFactor = value
                postInvalidateOnAnimation()
            }

            override fun get(counterFab: FabButton): Float {
                return 0f
            }
        }
    ...
    private val textPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        ...
        textSize = this@FabButton.textSize
    ...
    init {
        val styledAttributes = context.theme.obtainStyledAttributes(
            attrs, R.styleable.FabButton, 0, 0
        )
        textPaint.color =
            styledAttributes.getColor(R.styleable.FabButton_badgeTextColor, Color.WHITE)
        circlePaint.color = styledAttributes.getColor(
            R.styleable.FabButton_badgeBackgroundColor,
            getDefaultBadgeColor()
        )
        badgePosition =
            styledAttributes.getInt(R.styleable.FabButton_badgePosition, RIGHT_TOP_POSITION)
